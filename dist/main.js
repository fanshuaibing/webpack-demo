!function (t) {
	...
	n(3), (0, r.default)(), document.querySelector("input").addEventListener("click", function () {
		alert("点击了按钮")
	}), (0, o.default)()
}, function (t, e, n) {
	"use strict";
	...
	function f(t, e) {
		for (var n = 0; n < t.length; n++) {
			...
			if (i) {
				...
				var u = [];
				for (a = 0; a < o.parts.length; a++) u.push(b(o.parts[a], e));
	...
	function b(t, e) {
		...
		if (e.singleton) {
			var s = u++;
			n = a || (a = v(e)), r = m.bind(null, n, s, !1), o = m.bind(null, n, s, !0)
